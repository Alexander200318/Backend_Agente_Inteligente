...
import models  # Esto importa todos los modelos del __init__.py

# this is the Alembic Config object, which provides
# access to the values within the .ini file in use.
config = context.config

# ✅ CONFIGURAR LA URL DE CONEXIÓN PARA MARIADB SIN CONTRASEÑA
config.set_main_option(
    "sqlalchemy.url",
    "mysql+pymysql://root@localhost:3306/chatbot_institucional"
)
